            ...
            <div class="">
                ...
                if ($tintuc_detail['file']) {
                    ...
                    <div class="download-wrapper">
                        <a href="download.php?file=<?= $tintuc_detail['file'] ?>"><i
                                    class="glyphicon glyphicon-download-alt"></i>&nbsp; Tải
                            về <?= $tintuc_detail['file'] ?></a>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    if (count($gal)) {
                        ...
                        <link href="assets/plugins/light-gallery/css/lightGallery.css" type='text/css'
                              rel='stylesheet'/>
                        ...
                        <div class="box_containerlienhe">
                            <div class="">
                                <div class="title-global"><h2>Hình ảnh</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="">
                                    <div class="row-8">
                                        <ul id="light-gallery" class="grid"
                                            style="width:100%;padding:10px 0;border:1px solid #ccc;border-left:0;border-right:0">
                            ...
                            <ul>
                                <?php foreach ($tintuc_khac as $tinkhac) { ?>
                                    <li>&raquo;&nbsp;<a
                                        ...
                                        <span class="date">(<?= make_date($tinkhac['ngaytao']) ?>)</span></li>
                                <?php } ?>
                            </ul>
                        </div>
                    <?php } ?>
