				...
				echo '<div class="wrap-product">';
					echo '<div class="wrap-image col-xs-12 col-md-12 col-sm-12"><div class="row">';
						echo '<div class="relative-image">';
							...
							echo '<div class="xm-image"><a href="san-pham/'.$v['id'].'/'.$v['tenkhongdau'].'.html" title="'.$v['ten_'.$lang].'" class=""><img  src="timthumb.php?src='.$config_url."/"._upload_sanpham_l.$v['photo'].'&w=570&h=560&zc=2" onerror="'.$error.'" class="img-responsive" alt="'.$v['ten_'.$lang].'" onmouseout="hideTip()" onmouseover="doTooltip(event, \''._upload_sanpham_l.$v["photo"].'\')"/></a></div>';
							echo '<div class="tools">';
								...
								echo '<div class="price ">';
									echo '<span class="red">'.(($v['gia']) ? myformat($v['gia']) : 'Giá <a href="lien-he.html" title="Liên hệ">Liên hệ</a></span>').'</span>';
								echo '</div>';
								echo '</div><!-- end wrap-price -->';*/
							echo '<div class="clearfix"></div></div> <!-- end tools-->';
