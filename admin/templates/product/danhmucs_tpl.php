...
<table class="table table-bordered">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
		...
		<td align="center" style="width:80%;"><a href="index.php?com=<?=$_GET['com']?>&act=edit_danhmuc&id=<?=$items[$i]['id']?>"><?=$items[$i]['ten_vi']?>  (			<?php 
		...
		<td style="width:5%;"><a href="index.php?com=<?=$_GET['com']?>&act=edit_danhmuc&id=<?=$items[$i]['id']?>&title=<?=$_GET['title']?>&desc=<?=$_GET['desc']?>&content=<?=$_GET['content']?>" class="icon-form"><i class="glyphicon glyphicon-pencil"></i></a></td>
		<td style="width:5%;"><a href="index.php?com=<?=$_GET['com']?>&act=delete_danhmuc&id=<?=$items[$i]['id']?>&title=<?=$_GET['title']?>&desc=<?=$_GET['desc']?>&content=<?=$_GET['content']?>" onClick="if(!confirm('Xác nhận xóa: <?=$items[$i]['ten_vi']?>')) return false;" class="icon-form"><i class="glyphicon glyphicon-trash"></i></a></td>
	</tr>
	<?php	}?>
</table>


<a href="index.php?com=<?=$_GET['com']?>&act=add_danhmuc&title=<?=$_GET['title']?>&desc=<?=$_GET['desc']?>&content=<?=$_GET['content']?>" class="btn btn-info btn-flat  ">Thêm mới</a>
