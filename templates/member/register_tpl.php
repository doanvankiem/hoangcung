  ...
  <div class="modal reg_modal  fade" id="regestration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog" id="reg_outer_div"  >
      <div class="modal-content" style="background: white;">
		...
		<h4 class="modal-title" id="myModalLabel"><?=($type=="register") ? 'ĐĂNG KÝ THÀNH VIÊN' : 'ĐĂNG NHẬP' ?></h4>
        </div><!--/header-->
                ...
                <div id ="reg_body_inner_left" style=""> 
                                                            <div class="tabbable">
                                                              <ul class="nav nav-tabs">
                                                                <li class="<?=$at2?>"><a href="#pane_login" data-toggle="tab" data-title="ĐĂNG NHẬP">ĐĂNG NHẬP</a></li>
                                                               <!-- <li class="<?=$at1?>"><a href="#pane_reg" data-toggle="tab" data-title="ĐĂNG KÝ THÀNH VIÊN">ĐĂNG KÝ</a></li> -->
                                                                 ...
                                                                 <div id="pane_login" class="tab-pane <?=$at2?>">
                                                                    <form class="form-horizontal" id="form-login" role="form">
																		...
																		<div class="form-group last">
																			<div class="col-sm-offset-3 col-sm-9">
																				<button type="submit" class="btn btn-success btn-sm btn-blue">Đăng nhập</button>
