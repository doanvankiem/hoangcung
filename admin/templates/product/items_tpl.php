...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=product&act=delete<?=$request?>&listid=" + listid;
});
});
</script>
...
<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=product&act=man<?=$request_clear?>&id_danhmuc="+a.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=product&act=man<?=$request_clear?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=product&act=man<?=$request_clear?>&id_danhmuc="+a.value+"&id_list="+b.value+"&id_cat="+c.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=product&act=man<?=$request_clear?>&id_danhmuc="+a.value+"&id_list="+b.value+"&id_cat="+c.value+"&id_item="+d.value;	
		return true;
	}
...
<table class=" table table-bordered">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
		...
		<td style="width:15%;"><a href="index.php?com=product&act=edit&id=<?=$items[$i]['id']?><?=$request?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>
        <?php 
			if($_GET['class'] >= 1){
