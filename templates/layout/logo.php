...
<?=_logo_doitac?>
		...
		<ul id="flexiselDemo3">
			<?php
			foreach($logo as $k=>$v){
				echo '<li class="wow fadeInUp " data-wow-offset="100" data-wow-duration="1" data-wow-delay="'.(0.2*$k).'s"><div><div class="inner-target"><a target="_blank" title="'.$v['mota'].'" href="'.$v['mota'].'"><img src="timthumb.php?w=300&src='.$config_url."/"._upload_hinhanh_l.$v['photo'].'" /></a></div></div></li>';
			}
