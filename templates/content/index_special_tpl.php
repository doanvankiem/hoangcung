	...
	<?php 
		foreach($tintuc as $k=>$v){
			...
			<div class="header">
				...
				<div class="name">
					<h3><a href="<?=$com?>/<?=$v['id']?>/<?=$v['tenkhongdau']?>.html" title="<?=$v['ten_'.$lang]?>"><?=$v['ten_'.$lang]?></a></h3>
					<div class="clearfix"></div>
					<div class="tool"><i class="glyphicon glyphicon-user"></i>&nbsp;By Admin &nbsp;<i class="glyphicon glyphicon-comment"></i>&nbsp;<span class="fb-comments-count" data-href="<?=$config_url."/".$com?>/<?=$v['id']?>/<?=$v['tenkhongdau']?>.html">  </span> Bình luận</div>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="content">
				<div class="row-8">
					<div class="col-xs-5 col-8">
						<a href="<?=$com?>/<?=$v['id']?>/<?=$v['tenkhongdau']?>.html" title="<?=$v['ten_'.$lang]?>">
					...
					<div class="left-position-link col-xs-offet-5">
							<a  href="<?=$com?>/<?=$v['id']?>/<?=$v['tenkhongdau']?>.html" title="<?=$v['ten_'.$lang]?>">Xem chi tiết</a>
					</div>
				</div>	
			</div>
			<div class="clearfix"></div>
