...
if ($size) {
    ...
    $body .='<div class="clearfix"></div></div>';
			...
			$sql = "INSERT INTO  table_donhang (chitiet,thanhvien,madonhang,hoten,dienthoai,diachi,email,httt,tonggia,noidung,donhang,ngaytao,tinhtrang ) 
				  VALUES ('".mysql_real_escape_string(json_encode(($xcart)))."','".$_SESSION['member_log']['id']."','$mahoadon','$hoten','$dienthoai','$diachi','$email','$httt','$tonggia','$noidung','".magic_quote($body)."','$ngaydangky','1')";	
