...
function showProduct($v, $options = array())
{
    if (!isset($options['class'])) {
        $options['class'] = 'col-xs-12 col-sm-6 col-md-4 col-lg-4 item-product';
    }
    global $config_url, $lang;
    $error = "this.src='images/no_photo.png'";
    echo '<div class="' . $options['class'] . '" data-id="' . $v['id'] . '" data-name="' . $v['ten_' . $lang] . '">';
    ...
    if ($v['photo'] != '') {
        echo '<div class="xm-image"><a href="san-pham/' . $v['id'] . '/' . $v['tenkhongdau'] . '.html" title="' . $v['ten_' . $lang] . '" class=""><img  src="thumb/570x560/2/' . _upload_sanpham_l . $v['photo'] . '" onerror="' . $error . '" class="img-responsive" alt="' . $v['ten_' . $lang] . '" onmouseout="hideTip()" onmouseover="doTooltip(event, \'' . _upload_sanpham_l . $v["photo"] . '\')"/></a></div>';
    } else {
        echo '<div class="xm-image"><a href="san-pham/' . $v['id'] . '/' . $v['tenkhongdau'] . '.html" title="' . $v['ten_' . $lang] . '" class=""><img  src="images/no_photo.png" onerror="' . $error . '" class="img-responsive" alt="' . $v['ten_' . $lang] . '" onmouseout="hideTip()" onmouseover="doTooltip(event, \'images/no_photo.png\')"/></a></div>';
    }
    echo '<div class="tools">';

    echo '<div class="clearfix"></div>';
    echo '<div class="name ">';
    echo '<h2><a href="san-pham/' . $v['id'] . '/' . $v['tenkhongdau'] . '.html" title="' . $v['ten_' . $lang] . '">' . ($v['ten_' . $lang]) . '</a></h2>';
    echo '</div>';
    ...
    echo '<a href="javascript:void(0)" onclick="addToCart(\'' . $v['id'] . '\',\'' . $v['ten_' . $lang] . '\',1)">Giỏ hàng</a>';
    echo '</div>';
    echo '<div class="clearfix"></div>';
    echo '</div>';
    echo '</div></div>';
...
function showProductIndex($v, $options = array())
{
    if (!isset($options['class'])) {
        $options['class'] = 'col-xs-12 col-sm-6 col-md-4 col-lg-4 item-product';
    }
    ...
    echo '<div class="wrap-desc"><div class=" imt">';
    echo '<div class="product-name visible-xs">';
    echo '<h2><a href="san-pham/' . $v['id'] . '/' . $v['tenkhongdau'] . '.html" title="' . $v['ten_' . $lang] . '">' . $v['ten_' . $lang] . '</a></h2>';
    echo '</div>';
    echo '<div class="product-price hide">';
