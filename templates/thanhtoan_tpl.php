...
?>
		...
		<h4 class="title-child"><?=_cus_info?></h4>
    <form method="post" class="form-horizontal from-thanhtoan" name="frm_order" action="" enctype="multipart/form-data" role="form" onsubmit="return check();">          
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label"><?=_fullname?><span>*</span></label>
			<div class="col-sm-9">
				<input class="t form-control" name="ten" id="ten" required value="<?=@$m['fullname']?>" />
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input class="t form-control" name="dienthoai" id="dienthoai" required  value="<?=@$m['contact_phone']?>" />
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input class="t form-control" name="diachi"  id="diachi" required value="<?=@$m['contact_address']?>" />
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input class="t form-control" name="email" id="email" type="email" required value="<?=@$m['email']?>" />
    ...
    <div style="text-align: right; padding-top:20px;">
        ...
        <input title='tiếp tục' class="btn xbtn" type="submit" name="next" value="<?=_continue?>" style="cursor:pointer;"/>  
    </div>
      </form>
