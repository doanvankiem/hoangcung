	...
	<div id="tab-content">
		...
		<div class="col-xs-6">
			 ...
			 <div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="ten" value="<?=@$item['ten']?>" class="form-control " id="inputEmail3" required>
			...
			<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="link" value="<?=@$item['link']?>" class="form-control link" id="inputEmail3" required>
					  
					</div>
				 </div>
			<div class="form-group brimg">
				<label for="inputEmail3" class="col-sm-4 control-label">Hình</label>
			 ...
			 <label for="inputEmail3" class="col-sm-4 control-label"></label>
				<a class="fancybox"  href="<?=_upload_hinhanh.@$item['small_image']?>" ><img  id="main-image" src="<?=_upload_hinhanh.@$item['small_image']?>" class="col-xs-4" /></a>
